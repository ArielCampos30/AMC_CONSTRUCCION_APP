...
export function fitChatToViewport(){
...
export function dismissComposerAfterSend(form){
...
window.addEventListener('pageshow',()=>setTimeout(()=>{mobileViewportBaseline=Math.max(mobileViewportBaseline,window.visualViewport?.height||0,window.innerHeight||0);},250));

export function estimatorPageRoutes({ROOT,all,requireAdmin,readFileSync,path}){
 return function route({p,user,session,res}){
  ...
  html=html.replace('</body>','<script src="/amc-busy.js"></script><script src="/amc-confirm.js"></script><script src="/pdf-logo.js"></script><script src="/estimator-sync.js"></script><script src="/presupuestos-bridge.js"></script><script src="/estimator-steps.js"></script><script src="/estimator-shell-inner.js"></script></body>');
